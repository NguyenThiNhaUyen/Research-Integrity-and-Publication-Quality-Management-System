...
public class PaperVersionController(IPaperVersionService paperVersionService) : ApiBaseController
{
    ...
    public async Task<ActionResult<BaseResponse<PaperVersionResponseDto>>> Create(
        long paperId,
        CreatePaperVersionRequest request) =>
    ...
    public async Task<ActionResult<BaseResponse<List<PaperVersionResponseDto>>>> GetVersions(long paperId) =>
    ...
    [Authorize(Policy = "PAPER_VERSION_READ")]
    public async Task<ActionResult<BaseResponse<PaperVersionResponseDto>>> GetVersion(long paperId, long versionId) =>
    ...
    public async Task<ActionResult<BaseResponse<PaperVersionResponseDto>>> Update(
        long paperId,
        long versionId,
        UpdatePaperVersionRequest request) =>
    ...
    public async Task<ActionResult<BaseResponse<PaperVersionResponseDto>>> Restore(long paperId, long versionId) =>
