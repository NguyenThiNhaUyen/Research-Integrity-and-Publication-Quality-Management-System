    ...
    private static ISet<PermissionName> GetPermissionsForRole(RoleName roleName)
    {
        ...
        if (roleName == RoleName.LAB_LEADER)
        {
            permissions.UnionWith(new[]
            {
                ...
                PermissionName.PAPER_VERSION_UPLOAD, PermissionName.PAPER_VERSION_READ, PermissionName.PAPER_VERSION_COMPARE, PermissionName.PAPER_VERSION_DELETE,
        ...
        else if (roleName == RoleName.SENIOR_RESEARCHER)
        {
            permissions.UnionWith(new[]
            {
                ...
                PermissionName.PAPER_SUBMIT_INTERNAL_REVIEW, PermissionName.PAPER_VERSION_UPLOAD, PermissionName.PAPER_VERSION_READ, PermissionName.PAPER_VERSION_COMPARE,
                PermissionName.PAPER_VERSION_DELETE, PermissionName.QUALITY_CHECK_RUN, PermissionName.QUALITY_REPORT_READ,
